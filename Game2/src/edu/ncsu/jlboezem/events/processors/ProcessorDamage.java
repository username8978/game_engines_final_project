...
public class ProcessorDamage extends Processor {
	...
	public boolean handle(Event e) {
		...
		} else if (e.getType().matches(".*Spawn.*")) {
			Spawner.INSTANCE.spawn((String) e.getInfo().get("Spawn"), guid);
		}
		return true;
	}
	...
	public void subscribe() {
		...
		EventManager.INSTANCE.subscribe(this, ".*Spawn.*");
	}
